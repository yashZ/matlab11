function [rew] = simCamInd(realTrack,obsTrack,pomdp,VF,h,policy,VF1,pomdp1,nC)%,sVF,sh)
    ...
    for i = 1:length(realTrack);
        ...
        if strcmp(policy,'CamInd')
            ...
            %encact = getActValue(VF1,VF,pomdp1,belief',nC);
            %[dads,a] = ismember(encact,pomdp.encodedAction,'rows');
